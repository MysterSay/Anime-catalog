...
(() => {
  ...
  async function createNew() {
    ...
    try {
      ...
      console.error('[Anime -> Notion v2.3.0]', error);
  ...
  function buildUi() {
    ...
    panel.innerHTML = `
      ...
      <label class="an2n2-field"><span>Група</span><span class="an2n2-select-wrap"><select class="an2n2-group"></select></span></label>
