...
Vercel Python Core оновлюється до 2.11.0. Він повертає schema-v3 JSON з жанрами/темами, а Cloudflare Worker v7.2 зберігає ці поля у Turso.
...
Після переходу на Core 2.11.0 і сайт 7.2 старі записи можна дозаповнити без повного повторного пошуку по каталогах:
