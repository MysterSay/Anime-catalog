...
var worker_default = {
  async fetch(request, env) {
    ...
    try {
      ...
      if (url.pathname === "/api/version") return json({ ok: true, version: "yoru-v4.7-ui-search-runtime-fix-2026-08-11", addTitle: true, googleSourceSearch: true, googleSearchMode: "vercel-python-core", sourceSites: AUTHORITY_SITES, pythonCoreSearch: env.CORE_SEARCH_URL || CORE_SEARCH_URL, pythonCoreProcess: env.CORE_PROCESS_URL || CORE_PROCESS_URL, coreJsonIngest: true, ingestEndpoint: "/api/ingest", mediaRepair: true });
...
//# sourceMappingURL=bundledWorker-0.5634946016733674.mjs.map
