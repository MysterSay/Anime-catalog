...
var worker_default = {
  async fetch(request, env) {
    ...
    try {
      ...
      if (url.pathname === "/api/version") return json({ ok: true, version: "yoru-v7.2.3-compact-anime-api-2026-09-11", storage: "turso-libsql", pythonCoreSearch: env.CORE_SEARCH_URL || CORE_SEARCH_URL, pythonCoreProcessStream: env.CORE_PROCESS_STREAM_URL || CORE_PROCESS_STREAM_URL, pythonCoreProcessFull: env.CORE_PROCESS_FULL_URL || CORE_PROCESS_FULL_URL, progressProtocol: "ndjson-v1", coreJsonIngest: true, mergeTitles: true, deleteTitles: true, editTitles: true, extensionContext: "/api/extension/context", favoriteStorage: "turso-libsql", likedStorage: "turso-libsql", viewedStorage: "turso-libsql", seasonEpisodeStorage: "turso-libsql", groupSettings: "/api/groups", catalogSettings: "/api/catalog-settings", tagDelimiter: "dot", taxonomy: true, genreSources: GENRE_SOURCES, themeSources: THEME_SOURCES, coreTaxonomy: "/api/core-taxonomy" });
...
//# sourceMappingURL=bundledWorker-0.4124412088150453.mjs.map
